...
{
  description =
    "Nix flake for pythoneda-shared-artifact/artifact-events-infrastructure";
  inputs = rec {
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.11";
        sha256 = "0yb333wlw71cj78fpdga2izzpqhjrdwp434dg490hr0lgy1k6g98";
        pname = "${org}-${repo}";
        pythonpackage =
        ...
        pythoneda-shared-artifact-artifact-events-infrastructure-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-artifact-artifact-events} ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-pythonlang-infrastructure}; do
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-shared-artifact-artifact-events-infrastructure-python312;
          ...
          pythoneda-shared-artifact-artifact-events-infrastructure-python312 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-artifact-artifact-events-infrastructure-python312;
          ...
          pythoneda-shared-artifact-artifact-events-infrastructure-python313 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-artifact-artifact-events-infrastructure-python313;
